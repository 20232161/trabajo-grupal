...
git clone https://github.com/20232161/trabajo-grupal.git

PASO 3 Ingresar correo github en GIT 

git config --global user.email sucorreo
git config --global user.email 20232161@aloe.ulima.edu.pe
...
git branch chepecito

git checkout nombredelarama
git checkout chepecito
